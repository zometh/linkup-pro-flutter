...
void setupGetIt() {
  ...
  getIt.registerLazySingleton<AuthRepositoryImplement>(
    () => AuthRepositoryImplement(),
  );
  getIt.registerLazySingleton<RegisterRepositoryImplement>(
    () => RegisterRepositoryImplement(),
  );
  ...
  getIt.registerLazySingleton<CommentRepositoryImplement>(
    () => CommentRepositoryImplement(),
  );
  getIt.registerLazySingleton<UsersRepositoryImpl>(() => UsersRepositoryImpl());
  getIt.registerLazySingleton<PostActionRepositoryImplementation>(
    () => PostActionRepositoryImplementation(),
  );
  getIt.registerLazySingleton<ReportRepositoryImplement>(
    () => ReportRepositoryImplement(),
  );
  getIt.registerLazySingleton<AuthService>(() => AuthService());
  getIt.registerLazySingleton<ConversationRepositoryImplement>(
    () => ConversationRepositoryImplement(),
  );
  getIt.registerLazySingleton<MessageRepositoryImplement>(
    () => MessageRepositoryImplement(),
  );

  // Job offers repositories
  getIt.registerLazySingleton<JobOfferRepositoryImpl>(
    () => JobOfferRepositoryImpl(),
  );
  getIt.registerLazySingleton<JobApplicationRepositoryImpl>(
